...
var CleverTap = function (CleverTapAccountId, CleverTapAccountPasscode,CleverTapEndPoint) {
    ...
    if((CleverTapEndPoint && !(END_POINTS.includes(CleverTapEndPoint)))){
        throw new Error("Please provide a CleverTap EndPoint");
    }

    if(!CleverTapEndPoint){
        CleverTapEndPoint="eu1";
        console.log("Please provide a valid API Endpoint in ["+END_POINTS+"],We are redirecting to eu1 endpoint");
    }
