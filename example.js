...
clevertap.targets(
  ...
  { debug: 1 },
  (res) => {
    _log(clevertap.TARGET_ESTIMATE, res);
  }
);
// or if you prefer Promises
clevertap
...
clevertap.targets(
  ...
  { debug: 1 },
  (res) => {
    _log(clevertap.TARGET_CREATE, res);
  }
);
// or if you prefer Promises
clevertap
...
//callback style
clevertap.targets(clevertap.TARGET_LIST, listPayload, { debug: 1 }, (res) => {
  _log(clevertap.TARGET_LIST, res);
});
// or if you prefer Promises
clevertap
...
//callback style
clevertap.targets(clevertap.TARGET_STOP, stopPayload, { debug: 1 }, (res) => {
  _log(clevertap.TARGET_STOP, res);
});
// or if you prefer Promises
clevertap
...
clevertap.targets(
  ...
  { debug: 1 },
  (res) => {
    _log(clevertap.TARGET_RESULT, res);
  }
);
// or if you prefer Promises
clevertap
...
clevertap.realTimeCounts(realTimeCountspayload, { debug: 1 }).then((res) => {
  _log("RealTimeCount", res);
});
...
clevertap.trends(trendspayload, { debug: 1 }).then((res) => {
  _log("Trends", res);
});
